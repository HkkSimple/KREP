...
if __name__ == "__main__":
    ...
    args = getArgs()
    args.data_root_dir = root
    args.label_file_paths = ['/mnt/data/rz/data/idCard/rec/exp/gen/gen_train_rec_gt_number_label.txt', 
                             '/mnt/data/rz/data/idCard/rec/exp/gen/gen_train_rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0128_0206/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0128_0206/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0207_0210/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0207_0210/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0211_0217/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0211_0217/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0218_0226/rec_ppocr_key_label.txt',
                             '/mnt/data/rz/data/idCard/rec/exp/true/0218_0226/rec_ppocr_key_label.txt']
    # args.label_file_paths = ['/mnt/data/rz/data/idCard/rec/exp/gen/gen_val_rec_ppocr_key_label.txt']
    args.delimiter = 'tab'
    args.lmdb_out_dir = os.path.join(root, 'lmdb/20220228/train')
    # args.lmdb_out_dir = os.path.join(root, 'lmdb/20220228/val')
    args.check = True
    convert2lmdb(
